...
namespace Entities.Migrations
{
    ...
    {
        //Up will be executed while creating the database or while making changes into the existing table 
        ...
        //if u roolback the migration the down method executes which is rare
